...
/**
 * Configuración de Spring Boot específica para el perfil <b>mysqldev</b>.
 * 
 ...
 * activo de Spring es {@code mysqldev}.</p>
 *
 * <p>Incluye:
 * <ul>
 *   <li>Activación de repositorios JPA mediante {@link EnableJpaRepositories} 
 *       en el paquete base {@code ar.edu.iua.iw3}.</li>
 *   <li>Escaneo de entidades en paquetes del dominio, autenticación 
 *       y módulos de integración {@code cli1} y {@code cli2}.</li>
 * </ul>
 * </p>
 *
 * <p>Esta clase se carga únicamente si el perfil activo de Spring 
 * coincide con {@code mysqldev}.</p>
 *
 */
@Configuration
...
public class MysqldevScanConfig {
     ...
     * la configuración del contexto de Spring para el perfil {@code mysqldev}.</p>
     */
}